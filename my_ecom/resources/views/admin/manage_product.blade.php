               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        ...
                        @enderror
                        @if($image!='')
                        <a href="{{asset('storage/upload/product/'.$image)}}" target="_blank"><img width="100px" src="{{asset('storage/upload/product/'.$image)}}" /></a>
                        @endif
                     </div>
                     <div class="form-group">
                        <div class="row">
                     ...
                     <div class="form-group">
                        <div class="row" id="product_images_box">
                           ...
                           <div class="col-md-4 product_images_{{$loop_count_num++}}">
                              ...
                              @if($pIArr['images']!='')
                              <a href="{{asset('storage/upload/product/'.$pIArr['images'])}}" target="_blank"><img width="100px" src="{{asset('storage/upload/product/'.$pIArr['images'])}}" /></a>
                              @endif
                           </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              @if($pAArr['attr_image']!='')
                              <img width="100px" src="{{asset('storage/upload/product/'.$pAArr['attr_image'])}}" />
                              @endif
                           </div>
...
<script type='text/javascript'>
   ...
   $('#sub_category_id').change(function(){
         ...
         $.ajax({
           ...
           dataType: 'json',
           success: function(response){
            var values = response['data'][0].attributes_value;
            var len = 0;
            alert(values);
             if(response['data'] != null){
               len = response['data'].length;
