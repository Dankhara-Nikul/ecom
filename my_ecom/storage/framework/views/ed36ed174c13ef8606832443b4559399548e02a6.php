...
<html lang="en">
  <head>
    ...
    <script>
    var PRODUCT_IMAGE="<?php echo e(asset('storage/  /')); ?>";
    </script>
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><a href="<?php echo e(url('/order')); ?>">My Order</a></li>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
               ...
               <?php if($totalCartItem>0): ?>
                  ...
                  <p>Cart is Empty</p>
                  <?php endif; ?>
                  <a id="c1" class="aa-cartbox-checkout aa-primary-btn" href="<?php echo e(url('/cart')); ?>">Cart</a>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <ul class="aa-footer-nav">
                      <li><a href="#" data-toggle="modal" data-target="#login-modal">Login</a></li>
                      <li><a href="<?php echo e(url('registration')); ?>">Register</a></li>
...
</html><?php /**PATH E:\laravel\laravel8EcomPart48\my_ecom\resources\views/front/layout.blade.php ENDPATH**/ ?>