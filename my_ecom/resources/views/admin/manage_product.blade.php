                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3">
                              ...
                              <select id="fabric_id" name="fabric_id[]" class="form-control">
                                 <option value="">Select</option>
                                 @foreach($fabrics as $list)
                                    @if($pAArr['fabric_id']==$list->id)
                                    <option value="{{$list->id}}" selected>{{$list->fabric}}</option>
                                    @else
                                    <option value="{{$list->id}}">{{$list->fabric}}</option>
                                    @endif
                                 @endforeach
                              </select>
                           </div>
                           <div class="col-md-3">
                              ...
                              <select id="collar_id" name="collar_id[]" class="form-control">
                                 <option value="">Select</option>
                                 @foreach($collars as $list)
                                    @if($pAArr['collar_id']==$list->id)
                                    <option value="{{$list->id}}" selected>{{$list->collar}}</option>
                                    @else
                                    <option value="{{$list->id}}">{{$list->collar}}</option>
                                    @endif
                                 @endforeach
                              </select>
                           </div>
                           ...
                           <div class="col-md-3">
                              ...
                              <select id="pattern_id" name="pattern_id[]" class="form-control">
                                 ...
                                 @foreach($patterns as $list)
                                    @if($pAArr['pattern_id']==$list->id)
                                    <option value="{{$list->id}}" selected>{{$list->pattern}}</option>
                                    @else
                                    <option value="{{$list->id}}">{{$list->pattern  }}</option>
                                    @endif
                                 @endforeach
                              </select>
                           </div>
